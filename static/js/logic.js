...
// var baseURL = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/significant_day.geojson";
// Past 30 days - significan earthquakes
...
d3.json(baseURL, function(response) {
  ...
  for (var i = 0; i < response.features.length; i++) {
    ...
    if ( lat & lng & ( mag >0 | mag < 100 ) ){      
        ...
        // cityMarkers.push(
          ...
          }).bindPopup("<h2>" + location + "</h2> <hr> <h3>Magnitide: " + mag + "</h3>").addTo(myMap)
  ...
  legend.onAdd = function (map) {
    ...
    var colors = ['light-yello','yellow', 'lime', 'orange', 'pink', 'red'];
